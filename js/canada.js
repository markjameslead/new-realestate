...
/*function redirectToListings() {
  ...
  if (price != '' || location != '') {
    ...
    window.location.href = `../html/canadalistings.html?location=${encodeURIComponent(
      location
...
function redirectToListings() {
  ...
  window.location.href = 'canadalistings.html?' + params.toString()
}

function contactUs() {
  window.open('../html/canadacontactus.html')
}
